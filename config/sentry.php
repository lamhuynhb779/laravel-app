...
return [
    ...
    // O moi truong test thi ta dung traces_sample_rate de gui toan bo transactions toi Sentry
    // Con o moi truong production thi ta nen dung traces_sampler de giam chi phi
